...
from history.utils import get_exception_class
...
def test_custom_exceptions():
    exception_class = get_exception_class('history_test.custom_errors.custom_error.MyError')
...
def test_weird_custom_exception():
    exception_class = get_exception_class('history_test.custom_errors.custom_error.WeirdCustomException')
    with pytest.raises(exception_class) as exc_info:
