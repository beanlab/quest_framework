...
from history.persistence import PersistentList, LocalFileSystemBlobStorage
...
async def test_persistence_local():
    class FileSystemStorageContext:
        ...
        def __exit__(self, *args):
            TemporaryDirectory().__exit__(*args)
...
async def test_persistence_sql():
    from history.extras.sql import SQLDatabase, SqlBlobStorage
...
async def test_persistence_aws():
    from history.extras.aws import S3BlobStorage, S3Bucket, DynamoDB, DynamoDBBlobStorage
