from .. import WorkflowFactory, Historian, PersistentList, Book, BlobStorage, Blob

try:
    from sqlalchemy import create_engine, Column, Integer, String, JSON, Engine
    from sqlalchemy.orm import sessionmaker, Session, declarative_base
except ImportError:
    raise ImportError("The 'sql' extra is required to use this module. Run 'pip install history-py[sql]'.")
...
def create_sql_manager(
    ...
    def create_history(wid: str) -> Book:
        return PersistentList(wid, SqlBlobStorage(wid, database.get_session()))
